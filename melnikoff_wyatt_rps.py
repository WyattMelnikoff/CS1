...
#highest score user and bot can get to is 50 points
    score_limit = 50
#Both scores are less than their score limit.
...
#clear screen
            os.system("cls")
#ask player 2 to chose rock, paper, scissors 
...
#clear screen 
    ...
    #play again equals to would you like to play again? yes or no.

        play_again = input("Would you like to play again? y/n: ").lower()
    #if play again equals no
